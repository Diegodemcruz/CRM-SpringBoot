...
public class ClienteController {
	...
	@PostMapping ("/editar")
	public ModelAndView editar(Cliente cliente) throws ObjectNotFoundException{
	...
	@ResponseBody
	public Cliente findOneCliente(@PathVariable("usuario_id") Integer cliente_id) {
		return clienteService.findOneUsuario(cliente_id);
	}
